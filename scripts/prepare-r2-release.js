...
async function main() {
  ...
  const defaultNotes = [
    '1. 【防冷启动 3D 地形穿模与空白】优化高海拔山峰冷启动飞掠落地机制，前置微量地形预热并自动校准地表高程，杜绝落地后山体遮挡视野或黑屏空白；',
    '2. 【原生指针锚定缩放】滚轮缩放完全由 MapLibre 6.9 原生相机接管，光标锚定推进自然流畅，收敛至 L15 保证画质与零回弹；',
    '3. 【官方渲染引擎与抗锯齿】维持官方 MapLibre 6.9 渲染核心与低显存负载，保留路线精细几何容差，保障复杂地形运行流畅。'
  ].join('\n');
