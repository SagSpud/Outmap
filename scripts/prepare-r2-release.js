...
async function main() {
  ...
  const defaultNotes = [
    '1. 【彻底根治滚轮缩放反向回弹】深度优化 3D 地形相机动力学与碰撞避障引擎，彻底消除高山与峡谷极限视角下向前缩放时的画面顿挫与反向回弹拉扯，实现全中国复杂地形 0 回弹、60FPS 丝滑顺畅；',
    '2. 【DEM 瓦片流式加载防抖】优化高程数据就绪监听机制，消除地形瓦片后台加载完成瞬间的高程瞬态微调，保证静止与交互过渡绝对平稳；',
    '3. 【3D 地形旋转枢轴精准锚定】保持 3D 俯仰与旋转手势地表锚点 0 像素偏移，视口与地表山峰完美钉合；',
    '4. 【路线编辑体验全方位升级】保留途经点顺序清晰标示、已保存按钮紧凑美观、删除路线防复活与防重叠机制；',
    '5. 【秒级极速热更新】约 4.19MB 增量热更新包，启动即时生效。'
  ].join('\n');
