...
async function main() {
  ...
  const defaultNotes = [
    '1. 【100% 原生纯净缩放】彻底移除底层 zoomGuard 步长钳制与手势拦截，消除滚轮缩放反弹/回拉感，呈现极致丝滑的 60FPS 渲染；',
    '2. 【鼠标光标精准锚定】滚轮缩放改为原生跟随鼠标光标指针，指哪缩哪，告别视口中心离心漂移感；',
    '3. 【原生三维物理避障】完全交还 MapLibre 6.9 原生地形防穿模碰撞避障引擎，视点靠近高山自然平滑过渡；',
    '4. 【秒级极速应用内更新】仅约 4MB 增量热覆盖，秒级更新无缝重启。'
  ].join('\n');
