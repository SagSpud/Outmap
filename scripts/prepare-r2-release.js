...
async function main() {
  ...
  const defaultNotes = [
    '1. 【路线查看只读加固】查看收藏路线时全面锁定起终点/途经点输入、出行方式切换与算路按钮，杜绝意外触碰；',
    '2. 【原生路线投影吸附】新增屏幕空间高精线段投影算法，点击路线加点时精准吸附到线段而非折点，重绘更流畅；',
    '3. 【原始快照彻底还原】修复路线编辑后还原依赖可变数组的问题，改为不可变快照独立存储与回滚，还原 100% 可靠；',
    '4. 【响应式视口避让】完善桌面端与移动端双端安全 padding 动态计算，自适应面板折叠与屏幕尺寸，路线永不被遮挡；',
    '5. 【收藏搜索体验优化】优化收藏路线与地点即时过滤，搜索时不改变总数徽标，输入清空更平滑。'
  ].join('\n');
