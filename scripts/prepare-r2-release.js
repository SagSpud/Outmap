...
async function main() {
  ...
  const defaultNotes = [
    '1. 【途经点删除后序号与地名实时重排】彻底修复删除中间途经点后后续点序号在地图上显示为空白的底层渲染缺陷，确保删除任意点后所有后续点顺位序号（1, 2, 3...）在地图与面板中 100% 实时同步刷新；',
    '2. 【云同步删除路线防复活机制重构加固】修复删除墓碑合并时旧时间戳阻断新删除时间的冲突缺陷，实现“最新删除时间戳绝对胜出”，并在云端与本地彻底抹除已删路线残留，永久解决“删了就复原”问题；',
    '3. 【彻底根治滚轮缩放反向回弹】深度优化 3D 地形相机动力学与碰撞避障引擎，彻底消除高山与峡谷极限视角下向前缩放时的画面顿挫与反向回弹拉扯，实现全中国复杂地形 0 回弹、60FPS 丝滑顺畅；',
    '4. 【秒级极速热更新】约 4.19MB 增量热更新包，启动即时生效。'
  ].join('\n');
