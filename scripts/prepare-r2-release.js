...
async function main() {
  ...
  const defaultNotes = [
    '1. 【彻底消除路线点右键菜单重叠】在地图右键与长按触控监听中加入路线点图层检测与阻断，右键途径点/起点/终点时仅弹出路线点轻量交互卡片，彻底阻断通用地点上下文菜单弹出；',
    '2. 【路线点卡片与右键菜单互斥联动】展开路线点卡片时立即自动平滑退出通用右键菜单，唤起通用右键菜单时亦自动平滑收起路线点卡片，确保任何场景下绝不发生双菜单叠加；',
    '3. 【修复浏览模式点击途径点误展开路线规划面板】严格隔离浏览模式与编辑模式，在收藏夹查看路线或在地图上点击途径点时严格保持路线编辑面板收起，仅在收藏夹卡片右键选择“编辑路线”时才展开规划面板；',
    '4. 【事件穿透防护】针对 saved-route-casing 及地图空白处全局点击，增加 route-points 命中判断，点击途径点时杜绝触发背景路线重新加载或空白关闭逻辑。'
  ].join('\n');
