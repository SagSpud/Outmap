...
async function main() {
  ...
  const defaultNotes = [
    '1. 【3D地形路线抗锯齿与画质飞跃】地形 RTT 贴图分辨率翻倍至 1024×1024，矢量线段简化容差收敛至 0.1，彻底消除山地道路与导航路线折线锯齿；',
    '2. 【滚轮平滑全级缩放体验】解除缩放层级与中心强制约束，恢复自然流畅的光标锚定缩放，彻底消除缩放迟滞；',
    '3. 【右键旋转手势交互回正】重构旋转手势计算，消除上下半屏反向与极坐标突变，恢复全局一致的自然水平拖拽旋转。'
  ].join('\n');
