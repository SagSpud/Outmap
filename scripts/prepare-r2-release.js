...
async function main() {
  ...
  const defaultNotes = [
    '1. 【三维地形原生平滑避障与零穿透】全面重构高山地形相机避障模型，彻底根除高海拔峰峦（如贡嘎雪山、珠峰等）近距视角下的地表穿透穿模，相机视点恒定保持安全净空（≥35m）；',
    '2. 【无人工限幅，100%原生语义零回弹】彻底消除改写基准高程导致的矩阵与射线偏移，缩放手势严格单调递进，反向滚轮即刻顺滑拉出；生命周期精准同步中心真实地表高程；',
    '3. 【全视角稳定性与姿态锁死】全面通过全国9大复杂山系与平原自动化测试，360°旋转中心漂移严格≤1px，50°及自定义俯仰角锁定100%稳固；',
