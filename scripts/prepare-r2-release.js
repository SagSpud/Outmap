...
async function main() {
  ...
  const defaultNotes = [
    '1. 收藏地点、搜索地标与路线规划点飞掠层级统一收束至 13.0 黄金视级，避免过度放大；',
    '2. 优化飞跃锚点：自动扣除右侧展开面板，地标在 3D 俯仰视角下稳定停在视觉“中间偏下”（~68%），上方 2/3 开阔纵览前方路线与地形起伏；',
    '3. 彻底移除底部状态栏右下角 FPS 性能计数及分隔符，界面更加极简纯净；',
    '4. 消除飞跃与大层级下的图层闪烁拉扯，优化矢量符号与高程对齐；',
    '5. 地级市与县镇注记新增微观层级上限（maxzoom: 14 / 15.5），放大到街道级别时不被巨幅城市名遮挡；',
    '6. 收藏夹文件夹标签支持原生拖拽排序、重命名与删除，地点与路线右键重命名置于菜单最底部；',
    '7. 完整保留全部已有离线瓦片与目录配置，不移动、不删除任何本地数据。'
  ].join('\n');
