...
app.whenReady().then(async () => {
  ...
  // Assertions:
  assert.strictEqual(result.appVersion, '1.8.2', 'App version should be 1.8.2');
  assert.strictEqual(result.badgeText, 'v1.8.2', 'Badge text should be v1.8.2');
  ...
  assert.strictEqual(result.hasOnWindowFocus, true, 'onWindowFocus IPC handler must exist');
