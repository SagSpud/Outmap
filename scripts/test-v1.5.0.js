...
// 版本号检查
assert.strictEqual(pkg.version, '1.6.4', 'package.json version must be 1.6.4');
assert(htmlSrc.includes('app.js?v=1.6.4'), 'index.html must reference app.js?v=1.6.4');
assert(htmlSrc.includes('location-camera.js?v=1.6.4'), 'index.html must reference location-camera.js?v=1.6.4');
assert(htmlSrc.includes('style.css?v=1.6.4'), 'index.html must reference style.css?v=1.6.4');
assert(htmlSrc.includes('v1.6.4'), 'index.html must show v1.6.4 badge');
assert(appSrc.includes("const APP_VERSION = '1.6.4'"), 'app.js must declare APP_VERSION 1.6.4');
