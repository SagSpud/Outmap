...
assert(htmlSrc.includes('app.js?v=1.7.0'), 'index.html must reference app.js?v=1.7.0');
assert(htmlSrc.includes('location-camera.js?v=1.7.0'), 'index.html must reference location-camera.js?v=1.7.0');
assert(htmlSrc.includes('style.css?v=1.7.0'), 'index.html must reference style.css?v=1.7.0');
assert(htmlSrc.includes('v1.7.0'), 'index.html must show v1.7.0 badge');
assert(appSrc.includes("const APP_VERSION = '1.7.0'"), 'app.js must declare APP_VERSION 1.7.0');
