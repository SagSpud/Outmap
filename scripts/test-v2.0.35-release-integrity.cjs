...
console.log('🚀 Starting Outmap v2.0.35 Release Integrity & Regression Test Suite...\n');
...
console.log('[Test 1] Version 2.0.35 Consistency Audit...');
assert.strictEqual(pkg.version, '2.0.35', 'package.json version must be 2.0.35');
assert(appSource.includes("const APP_VERSION = '2.0.35';"), 'app.js must declare APP_VERSION 2.0.35');
assert(htmlSource.includes('style.css?v=2.0.35'), 'index.html must link style.css?v=2.0.35');
assert(htmlSource.includes('>v2.0.35</span>'), 'index.html brand badge must display v2.0.35');
assert(htmlSource.includes('map-bootstrap.js?v=2.0.35'), 'index.html must import map-bootstrap.js?v=2.0.35');

const expectedScripts = [
  'terrain-contours.js?v=2.0.35',
  'map-native-icons.js?v=2.0.35',
  'location-camera.js?v=2.0.35',
  'favorite-interactions.js?v=2.0.35',
  'geo-constants.js?v=2.0.35',
  'route-simulator.js?v=2.0.35',
  'storage-maintenance.js?v=2.0.35',
  'app.js?v=2.0.35'
];
for (const s of expectedScripts) {
  assert(bootSource.includes(s), `map-bootstrap.js must include ${s}`);
}
console.log('  ✅ Test 1 passed: All core files strictly aligned to v2.0.35.');

// [Test 2] Modal Anti-Bleed & Visual Contrast
console.log('\n[Test 2] Modal Anti-Bleed & Visual Contrast Audit...');
...
console.log('  ✅ Test 2 passed: Modal solid white card and deep backdrop contrast verified.');

// [Test 3] Escape Key Hierarchy & Capture Dispatch
console.log('\n[Test 3] Escape Key Hierarchy & Capture Dispatch Audit...');
...
console.log('  ✅ Test 3 passed: Escape capture & modal hierarchy isolation verified.');

// [Test 4] Silky Camera Flight Dynamics
console.log('\n[Test 4] Silky Camera Flight Dynamics Model...');
...
console.log('  ✅ Test 4 passed: Camera flight mathematical model verified.');

console.log('\n======================================================');
console.log('🎉 ALL v2.0.35 RELEASE INTEGRITY CHECKS PASSED 100%!');
console.log('======================================================\n');
