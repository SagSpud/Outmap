...
assert(['1.6.7', '1.6.8', '1.6.9', '1.7.0', '1.7.1', '1.7.2', '1.7.3', '1.7.4'].includes(packageJson.version), 'package.json version must be valid');
...
assert(indexHtml.includes('v1.6.7') || indexHtml.includes('v1.6.8') || indexHtml.includes('v1.6.9') || indexHtml.includes('v1.7.0') || indexHtml.includes('v1.7.1') || indexHtml.includes('v1.7.2') || indexHtml.includes('v1.7.3') || indexHtml.includes('v1.7.4'), 'index.html must display version badge');
...
app.whenReady().then(async () => {
  ...
  assert(['v1.6.7', 'v1.6.8', 'v1.6.9', 'v1.7.0', 'v1.7.1', 'v1.7.2', 'v1.7.3', 'v1.7.4'].includes(results.badgeText), 'Brand badge must display valid version');
