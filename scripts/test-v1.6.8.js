...
assert(['1.6.8', '1.6.9', '1.7.0', '1.7.1'].includes(packageJson.version), 'package.json version must be valid');
assert(appJs.includes("const APP_VERSION = '1.6.8'") || appJs.includes("const APP_VERSION = '1.6.9'") || appJs.includes("const APP_VERSION = '1.7.0'") || appJs.includes("const APP_VERSION = '1.7.1'"), 'app.js must declare APP_VERSION');
assert(indexHtml.includes('style.css?v=1.6.8') || indexHtml.includes('style.css?v=1.6.9') || indexHtml.includes('style.css?v=1.7.0') || indexHtml.includes('style.css?v=1.7.1'), 'index.html must reference style.css');
assert(indexHtml.includes('location-camera.js?v=1.6.8') || indexHtml.includes('location-camera.js?v=1.6.9') || indexHtml.includes('location-camera.js?v=1.7.0') || indexHtml.includes('location-camera.js?v=1.7.1'), 'index.html must reference location-camera.js');
assert(indexHtml.includes('app.js?v=1.6.8') || indexHtml.includes('app.js?v=1.6.9') || indexHtml.includes('app.js?v=1.7.0') || indexHtml.includes('app.js?v=1.7.1'), 'index.html must reference app.js');
assert(indexHtml.includes('v1.6.8') || indexHtml.includes('v1.6.9') || indexHtml.includes('v1.7.0') || indexHtml.includes('v1.7.1'), 'index.html must display version badge');
...
app.whenReady().then(async () => {
  ...
  assert(['v1.6.8', 'v1.6.9', 'v1.7.0', 'v1.7.1'].includes(results.badgeText), 'Brand badge must display valid version');
