...
assert.strictEqual(pkg.version, '1.9.21', 'package.json version must be 1.9.21');
assert.strictEqual(lock.version, '1.9.21', 'package-lock.json version must be 1.9.21');
assert.strictEqual(lock.packages[''].version, '1.9.21', 'package-lock.json root package version must be 1.9.21');
assert(app.includes("const APP_VERSION = '1.9.21';"), 'app.js must declare current APP_VERSION');
assert(html.includes('style.css?v=1.9.21'), 'index.html must reference current style.css');
assert(html.includes('app.js?v=1.9.21'), 'index.html must reference current app.js');
assert(html.includes('location-camera.js?v=1.9.21'), 'index.html must reference current location-camera.js');
assert(html.includes('id="brand-ver-badge-txt">v1.9.21</span>'), 'index.html must display v1.9.21');
