...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.70',
  'map-native-icons.js?v=2.0.70',
  'location-camera.js?v=2.0.70',
  'favorite-interactions.js?v=2.0.70',
  'geo-constants.js?v=2.0.70',
  'storage-maintenance.js?v=2.0.70',
  'app.js?v=2.0.70'
];
