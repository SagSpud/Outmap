...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.72',
  'map-native-icons.js?v=2.0.72',
  'location-camera.js?v=2.0.72',
  'favorite-interactions.js?v=2.0.72',
  'geo-constants.js?v=2.0.72',
  'storage-maintenance.js?v=2.0.72',
  'app.js?v=2.0.72'
];
