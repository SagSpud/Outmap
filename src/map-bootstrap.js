...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.50',
  'map-native-icons.js?v=2.0.50',
  'location-camera.js?v=2.0.50',
  'favorite-interactions.js?v=2.0.50',
  'geo-constants.js?v=2.0.50',
  'storage-maintenance.js?v=2.0.50',
  'app.js?v=2.0.50'
];
