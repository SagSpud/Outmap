...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.57',
  'map-native-icons.js?v=2.0.57',
  'location-camera.js?v=2.0.57',
  'favorite-interactions.js?v=2.0.57',
  'geo-constants.js?v=2.0.57',
  'storage-maintenance.js?v=2.0.57',
  'app.js?v=2.0.57'
];
