...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.65',
  'map-native-icons.js?v=2.0.65',
  'location-camera.js?v=2.0.65',
  'favorite-interactions.js?v=2.0.65',
  'geo-constants.js?v=2.0.65',
  'storage-maintenance.js?v=2.0.65',
  'app.js?v=2.0.65'
];
