...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.51',
  'map-native-icons.js?v=2.0.51',
  'location-camera.js?v=2.0.51',
  'favorite-interactions.js?v=2.0.51',
  'geo-constants.js?v=2.0.51',
  'storage-maintenance.js?v=2.0.51',
  'app.js?v=2.0.51'
];
