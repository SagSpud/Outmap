...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.43',
  'map-native-icons.js?v=2.0.43',
  'location-camera.js?v=2.0.43',
  'favorite-interactions.js?v=2.0.43',
  'geo-constants.js?v=2.0.43',
  'storage-maintenance.js?v=2.0.43',
  'app.js?v=2.0.43'
];
