...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.66',
  'map-native-icons.js?v=2.0.66',
  'location-camera.js?v=2.0.66',
  'favorite-interactions.js?v=2.0.66',
  'geo-constants.js?v=2.0.66',
  'storage-maintenance.js?v=2.0.66',
  'app.js?v=2.0.66'
];
