...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.48',
  'map-native-icons.js?v=2.0.48',
  'location-camera.js?v=2.0.48',
  'favorite-interactions.js?v=2.0.48',
  'geo-constants.js?v=2.0.48',
  'storage-maintenance.js?v=2.0.48',
  'app.js?v=2.0.48'
];
