...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.76',
  'map-native-icons.js?v=2.0.76',
  'location-camera.js?v=2.0.76',
  'favorite-interactions.js?v=2.0.76',
  'geo-constants.js?v=2.0.76',
  'storage-maintenance.js?v=2.0.76',
  'app.js?v=2.0.76'
];
