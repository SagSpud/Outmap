...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.59',
  'map-native-icons.js?v=2.0.59',
  'location-camera.js?v=2.0.59',
  'favorite-interactions.js?v=2.0.59',
  'geo-constants.js?v=2.0.59',
  'storage-maintenance.js?v=2.0.59',
  'app.js?v=2.0.59'
];
