...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.64',
  'map-native-icons.js?v=2.0.64',
  'location-camera.js?v=2.0.64',
  'favorite-interactions.js?v=2.0.64',
  'geo-constants.js?v=2.0.64',
  'storage-maintenance.js?v=2.0.64',
  'app.js?v=2.0.64'
];
