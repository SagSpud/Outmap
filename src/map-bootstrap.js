...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.71',
  'map-native-icons.js?v=2.0.71',
  'location-camera.js?v=2.0.71',
  'favorite-interactions.js?v=2.0.71',
  'geo-constants.js?v=2.0.71',
  'storage-maintenance.js?v=2.0.71',
  'app.js?v=2.0.71'
];
