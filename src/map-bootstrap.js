...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.45',
  'map-native-icons.js?v=2.0.45',
  'location-camera.js?v=2.0.45',
  'favorite-interactions.js?v=2.0.45',
  'geo-constants.js?v=2.0.45',
  'storage-maintenance.js?v=2.0.45',
  'app.js?v=2.0.45'
];
