...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.74',
  'map-native-icons.js?v=2.0.74',
  'location-camera.js?v=2.0.74',
  'favorite-interactions.js?v=2.0.74',
  'geo-constants.js?v=2.0.74',
  'storage-maintenance.js?v=2.0.74',
  'app.js?v=2.0.74'
];
