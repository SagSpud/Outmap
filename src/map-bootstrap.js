...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.58',
  'map-native-icons.js?v=2.0.58',
  'location-camera.js?v=2.0.58',
  'favorite-interactions.js?v=2.0.58',
  'geo-constants.js?v=2.0.58',
  'storage-maintenance.js?v=2.0.58',
  'app.js?v=2.0.58'
];
