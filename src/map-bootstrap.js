...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.55',
  'map-native-icons.js?v=2.0.55',
  'location-camera.js?v=2.0.55',
  'favorite-interactions.js?v=2.0.55',
  'geo-constants.js?v=2.0.55',
  'storage-maintenance.js?v=2.0.55',
  'app.js?v=2.0.55'
];
