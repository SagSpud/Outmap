...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.44',
  'map-native-icons.js?v=2.0.44',
  'location-camera.js?v=2.0.44',
  'favorite-interactions.js?v=2.0.44',
  'geo-constants.js?v=2.0.44',
  'storage-maintenance.js?v=2.0.44',
  'app.js?v=2.0.44'
];
