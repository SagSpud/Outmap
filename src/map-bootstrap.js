...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.73',
  'map-native-icons.js?v=2.0.73',
  'location-camera.js?v=2.0.73',
  'favorite-interactions.js?v=2.0.73',
  'geo-constants.js?v=2.0.73',
  'storage-maintenance.js?v=2.0.73',
  'app.js?v=2.0.73'
];
