...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.47',
  'map-native-icons.js?v=2.0.47',
  'location-camera.js?v=2.0.47',
  'favorite-interactions.js?v=2.0.47',
  'geo-constants.js?v=2.0.47',
  'storage-maintenance.js?v=2.0.47',
  'app.js?v=2.0.47'
];
