...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.75',
  'map-native-icons.js?v=2.0.75',
  'location-camera.js?v=2.0.75',
  'favorite-interactions.js?v=2.0.75',
  'geo-constants.js?v=2.0.75',
  'storage-maintenance.js?v=2.0.75',
  'app.js?v=2.0.75'
];
