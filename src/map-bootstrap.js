...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.60',
  'map-native-icons.js?v=2.0.60',
  'location-camera.js?v=2.0.60',
  'favorite-interactions.js?v=2.0.60',
  'geo-constants.js?v=2.0.60',
  'storage-maintenance.js?v=2.0.60',
  'app.js?v=2.0.60'
];
