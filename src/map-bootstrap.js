...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.53',
  'map-native-icons.js?v=2.0.53',
  'location-camera.js?v=2.0.53',
  'favorite-interactions.js?v=2.0.53',
  'geo-constants.js?v=2.0.53',
  'storage-maintenance.js?v=2.0.53',
  'app.js?v=2.0.53'
];
