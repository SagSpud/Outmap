...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.63',
  'map-native-icons.js?v=2.0.63',
  'location-camera.js?v=2.0.63',
  'favorite-interactions.js?v=2.0.63',
  'geo-constants.js?v=2.0.63',
  'storage-maintenance.js?v=2.0.63',
  'app.js?v=2.0.63'
];
