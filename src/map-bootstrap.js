...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.62',
  'map-native-icons.js?v=2.0.62',
  'location-camera.js?v=2.0.62',
  'favorite-interactions.js?v=2.0.62',
  'geo-constants.js?v=2.0.62',
  'storage-maintenance.js?v=2.0.62',
  'app.js?v=2.0.62'
];
