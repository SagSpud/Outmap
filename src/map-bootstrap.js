...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.42',
  'map-native-icons.js?v=2.0.42',
  'location-camera.js?v=2.0.42',
  'favorite-interactions.js?v=2.0.42',
  'geo-constants.js?v=2.0.42',
  'storage-maintenance.js?v=2.0.42',
  'app.js?v=2.0.42'
];
