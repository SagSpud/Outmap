...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.52',
  'map-native-icons.js?v=2.0.52',
  'location-camera.js?v=2.0.52',
  'favorite-interactions.js?v=2.0.52',
  'geo-constants.js?v=2.0.52',
  'storage-maintenance.js?v=2.0.52',
  'app.js?v=2.0.52'
];
