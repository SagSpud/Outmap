...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.56',
  'map-native-icons.js?v=2.0.56',
  'location-camera.js?v=2.0.56',
  'favorite-interactions.js?v=2.0.56',
  'geo-constants.js?v=2.0.56',
  'storage-maintenance.js?v=2.0.56',
  'app.js?v=2.0.56'
];
