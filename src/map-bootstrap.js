...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.67',
  'map-native-icons.js?v=2.0.67',
  'location-camera.js?v=2.0.67',
  'favorite-interactions.js?v=2.0.67',
  'geo-constants.js?v=2.0.67',
  'storage-maintenance.js?v=2.0.67',
  'app.js?v=2.0.67'
];
