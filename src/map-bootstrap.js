...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.61',
  'map-native-icons.js?v=2.0.61',
  'location-camera.js?v=2.0.61',
  'favorite-interactions.js?v=2.0.61',
  'geo-constants.js?v=2.0.61',
  'storage-maintenance.js?v=2.0.61',
  'app.js?v=2.0.61'
];
