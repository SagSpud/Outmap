...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.54',
  'map-native-icons.js?v=2.0.54',
  'location-camera.js?v=2.0.54',
  'favorite-interactions.js?v=2.0.54',
  'geo-constants.js?v=2.0.54',
  'storage-maintenance.js?v=2.0.54',
  'app.js?v=2.0.54'
];
