...
const scripts = [
  ...
  'terrain-contours.js?v=2.0.46',
  'map-native-icons.js?v=2.0.46',
  'location-camera.js?v=2.0.46',
  'favorite-interactions.js?v=2.0.46',
  'geo-constants.js?v=2.0.46',
  'storage-maintenance.js?v=2.0.46',
  'app.js?v=2.0.46'
];
